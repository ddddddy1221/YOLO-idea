...
"""
#修改G C S 
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, Focal=False, alpha=1, gamma=0.5, eps=1e-7):# alpha 默认为3 1的话就不使用
    # Returns Intersection over Union (IoU) of box1(1,4) to box2(n,4)
